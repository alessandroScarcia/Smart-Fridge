 ...
 */
	...
	/* La funzione split_u_misura si occupa di dividere la stringa che possiede la quantitá del prodotto con la relativa unitá di misura
	 ...
	 * Nel caso in cui la data di scadenza che viene passata é una stringa vuota ossia non é presente la data di scadenza per un alimento
	 * sará il programma ad assegnarne una(almeno 3 giorni dopo la data di memorizzazione)*/
